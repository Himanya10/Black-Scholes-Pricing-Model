...
st.markdown( """
  <style>
  /* Adjust the size & alignment of the CALL and PUT value containers */
  .metric-container{
    display: flex;
  ...
  .metric-call{
    ...
    border-radius: 10 px /* Rounded corners */
  }
  ...
  .metric-value {
    font-size: 1.5 rem; /* Adjust font size */
    font-weight: bold;
...
with st.sidebar:
  ...
  spot_min = st.number_input('Min Spot Price', min_value=0.01, value = current_prices * 0.8, step = 0.01)
